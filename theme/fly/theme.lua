...
theme.notification_bg = theme.topbar_bg .. "a0"
theme.notification_fg = theme.startup_bg
theme.notification_font = "SF Pro Display 12"
...
theme.wallpaper = "/home/mt/Tools/flyawesome/example/assets/wallpaper/YourName/Your_Name_2.jpg"
